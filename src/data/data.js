...
const heroapi = {
    title: "Check that pair of Nikes",
...
const highlight = {
    ...
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt est eum alias numquam hic quo voluptas error rerum, mollitia laboriosam, quos cum aspernatur tempora perspiciatis temporibus, blanditiis totam fugiat cumque.",
    btn: "Explore More",
...
const toprateslaes = {
    ...
    items: [
        ...
        },
        {
            ...
            img: product4,
            price: "150",
            color: "from-orange-100 to-amber-5100",
        ...
        },
        {
            ...
            img: product9,
            price: "150",
            color: "from-[#f7ab88] to-orange-100",
            shadow: "shadow-sm shadow-orange-100",
        },
        {
            id: "0M0x9",
        ...
        },
        {
            ...
            shadow: "shadow-sm shadow-lime-100",
        },
        {
            id: "0M0x11",
            ...
            img: product11,
            price: "150",
            color: "from-slate-100 to-gray",
            shadow: "shadow-sm shadow-slate-300",
        },
        {
            id: "0M0x12",
            title: "Nike Zoom Max",
...
const footerAPI = {
    titles: [{ title: "About" }, { title: "Get Help" }, { title: "Info" }],
    links: [
        [
            { link: "News" },
            { link: "Careers" },
