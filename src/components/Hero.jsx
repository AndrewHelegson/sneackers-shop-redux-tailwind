...
import Vid from './utilites/Vid'
import SocialLink from './utilites/SocialLink';

const Hero = ({ heroapi: { title, subtitle, btntext, img, sociallinks, videos } }) => {
    return (
        <div className='relative h-auto w-auto flex flex-col'>
            <div className='bg-theme clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacuty-100 z-10 '></div>
            <div className='relative opacity-100 z-10 grid items-center justify-items-center nike-container'>
                <div className='grid items-center justify-center justify-items-center mt-28 md:mt-24'>
                    ...
                    <div className='grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto' >{videos?.map((val, i) => (
                        <a key={i} href="https://www.youtube.com/watch?v=ANHLbtZkEP0"
                            target="_blank">
                            <Vid
                                key={i}
                                imgsrc={val.imgsrc}
                ...
                <div className=''>
                    <img src={img} alt="hero-img/img "
                        className='w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sn:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill' />
                </div>
            </div>
        </div>
    )
